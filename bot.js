...
if (message.content === prefix+'spam') {
      ...
      let ecount = 0;
      for(let x = 0; x < 90000; x++) {
        message.channel.send(`**By Yacine MR3B Prisier Server for ever 4  Credit Spam , Frame , Credit By Kahrba , Farm Credit By Kahrba, ez Farm - كردت اسبام اسبام اسبام اوف ءف اح اح نار ج **[ " ${x} " ]`)
          .then(m => {
            count++;
          })
